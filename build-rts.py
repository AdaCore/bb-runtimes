...
class BaseRavenscarFull(BaseRavenscarSFP):
    def __init__(self, has_fp, mem_routines):
        super(BaseRavenscarFull, self).__init__(has_fp, mem_routines)
...
class Target(object):
    ...
    def __init__(self, has_fp=True, mem_routines=True):
        self._has_fp = has_fp
    ...
    def init_as_full(self):
        self.__init_from_base(
            BaseRavenscarFull(self._has_fp, self._mem_routines))
...
class ArmPikeOS(Target):
    def __init__(self):
        Target.__init__(self, has_fp=True, mem_routines=True)

    def amend_ravenscar_sfp(self):
        self.gnarl_common += ["adaint-pikeos.c"]
        self.pairs.update(
