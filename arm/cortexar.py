...
class CortexARArch(ArchSupport):
    ...
    def __init__(self):
        ...
        self.add_gnarl_sources("src/s-bbcpsp__arm.ads", "src/s-bbcppr__new.ads")
...
class AM64xR5(CortexARTarget):
    ...
    def __init__(self):
        ...
        self.add_gnarl_sources(
            ...
            "src/g-interr__ti_vim.ads",
            "src/g-interr__ti_vim.adb",
            "src/s-bbpara__am64xr5.ads",
            "src/s-bbbosu__am64xr5.adb",
...
class Rpi2Base(CortexARTarget):
    ...
    def __init__(self):
        ...
        self.add_gnat_sources("src/i-raspberry_pi.ads", "src/s-macres__rpi2.adb")
        self.add_gnarl_sources(
            "src/a-intnam__rpi2.ads", "src/s-bbbosu__rpi2.adb", "src/s-bbcppr__arm.adb"
        )
...
class Rpi2(Rpi2Base):
    ...
    def __init__(self):
        ...
        self.add_gnat_sources(
            "arm/rpi2/start-ram.S", "arm/rpi2/memmap.S", "src/s-textio__rpi2-mini.adb"
        )
...
class TMS570(CortexARTarget):
    ...
    def add_linker_scripts(self):
        ...
        self.add_linker_script("arm/tms570/%s.ld" % self.variant, dst="tms570.ld")
...
class ZynqmpR5(CortexARTarget):
    ...
    def __init__(self):
        ...
        self.add_gnat_sources("src/s-textio__zynqmp.adb", "src/s-macres__zynqmp.adb")
