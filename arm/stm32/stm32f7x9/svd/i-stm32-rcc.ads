...
package Interfaces.STM32.RCC is
   ...
   subtype CR_PLLSAION_Field is Interfaces.Bit_Types.Bit;
   subtype CR_PLLSAIRDY_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB1RSTR_LPTIM1RST_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB1RSTR_SPDIFRXRST_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB2RSTR_SDMMC2RST_Field is Interfaces.Bit_Types.Bit;
   subtype APB2RSTR_ADCRST_Field is Interfaces.Bit_Types.Bit;
   subtype APB2RSTR_SDMMC1RST_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB2RSTR_SAI2RST_Field is Interfaces.Bit_Types.Bit;
   subtype APB2RSTR_LTDCRST_Field is Interfaces.Bit_Types.Bit;
   subtype APB2RSTR_DSIRST_Field is Interfaces.Bit_Types.Bit;
   subtype APB2RSTR_DFSDM1RST_Field is Interfaces.Bit_Types.Bit;
   subtype APB2RSTR_MDIORST_Field is Interfaces.Bit_Types.Bit;
   ...
   type APB2RSTR_Register is record
      ...
      --  SDMMC2 reset
      SDMMC2RST      : APB2RSTR_SDMMC2RST_Field := 16#0#;
      ...
      --  MDIO reset
      MDIORST        : APB2RSTR_MDIORST_Field := 16#0#;
      --  unspecified
   ...
   subtype APB1ENR_LPTMI1EN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB1ENR_SPDIFRXEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB2ENR_SDMMC2EN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB2ENR_SDMMC1EN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB2ENR_SAI2EN_Field is Interfaces.Bit_Types.Bit;
   subtype APB2ENR_LTDCEN_Field is Interfaces.Bit_Types.Bit;
   subtype APB2ENR_DSIEN_Field is Interfaces.Bit_Types.Bit;
   subtype APB2ENR_DFSDM1EN_Field is Interfaces.Bit_Types.Bit;
   subtype APB2ENR_MDIOEN_Field is Interfaces.Bit_Types.Bit;
   ...
   type APB2ENR_Register is record
      ...
      Reserved_6_6   : Interfaces.Bit_Types.Bit := 16#0#;
      --  SDMMC2 clock enable
      SDMMC2EN       : APB2ENR_SDMMC2EN_Field := 16#0#;
      --  ADC1 clock enable
      ...
      --  MDIO clock enable
      MDIOEN         : APB2ENR_MDIOEN_Field := 16#0#;
      --  unspecified
      Reserved_31_31 : Interfaces.Bit_Types.Bit := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype APB1LPENR_LPTIM1LPEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB1LPENR_SPDIFRXLPEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB2LPENR_SDMMC1LPEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype APB2LPENR_SAI2LPEN_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype DKCFGR1_TIMPRE_Field is Interfaces.Bit_Types.Bit;
   ...
   subtype DKCFGR2_CECSEL_Field is Interfaces.Bit_Types.Bit;
   subtype DKCFGR2_CK48MSEL_Field is Interfaces.Bit_Types.Bit;
   subtype DKCFGR2_SDMMCSEL_Field is Interfaces.Bit_Types.Bit;
