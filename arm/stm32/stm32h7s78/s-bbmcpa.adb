...
package body System.BB.MCU_Parameters is
   ...
   is
   begin
      --  Set the PWR to VOS high (Scale 1) mode for 600 MHz operation
      --  STM32H7RS uses VOS high for maximum performance
   ...
   is
   begin
      --  STM32H7RS series doesn't use the overdrive mode like F7
      --  High performance is achieved through VOS scaling
