...
package Interfaces.STM32.SDIO is
   ...
   subtype DCTRL_RWSTART_Field is Interfaces.STM32.Bit;
   subtype DCTRL_RWSTOP_Field is Interfaces.STM32.Bit;
   ...
   subtype MASK_DBCKENDIE_Field is Interfaces.STM32.Bit;
   ...
   subtype MASK_CEATAENDIE_Field is Interfaces.STM32.Bit;
   ...
   subtype FIFOCNT_FIFOCOUNT_Field is Interfaces.STM32.UInt24;
   ...
   type SDIO_Peripheral is record
      ...
      RESP1   : aliased Interfaces.STM32.UInt32;
      --  response 1..4 register
