...
package Interfaces.STM32.ADC is
   ...
   subtype CR1_RES_Field is Interfaces.STM32.UInt2;
   subtype CR1_OVRIE_Field is Interfaces.STM32.Bit;
   ...
   subtype CR2_DDS_Field is Interfaces.STM32.Bit;
   subtype CR2_EOCS_Field is Interfaces.STM32.Bit;
   ...
   subtype CR2_EXTSEL_Field is Interfaces.STM32.UInt4;
   subtype CR2_EXTEN_Field is Interfaces.STM32.UInt2;
   ...
   subtype CSR_AWD1_Field is Interfaces.STM32.Bit;
   subtype CSR_EOC1_Field is Interfaces.STM32.Bit;
   subtype CSR_JEOC1_Field is Interfaces.STM32.Bit;
   subtype CSR_JSTRT1_Field is Interfaces.STM32.Bit;
   subtype CSR_STRT1_Field is Interfaces.STM32.Bit;
   subtype CSR_OVR1_Field is Interfaces.STM32.Bit;
   subtype CSR_AWD2_Field is Interfaces.STM32.Bit;
   subtype CSR_EOC2_Field is Interfaces.STM32.Bit;
   subtype CSR_JEOC2_Field is Interfaces.STM32.Bit;
   subtype CSR_JSTRT2_Field is Interfaces.STM32.Bit;
   subtype CSR_STRT2_Field is Interfaces.STM32.Bit;
   subtype CSR_OVR2_Field is Interfaces.STM32.Bit;
   subtype CSR_AWD3_Field is Interfaces.STM32.Bit;
   subtype CSR_EOC3_Field is Interfaces.STM32.Bit;
   subtype CSR_JEOC3_Field is Interfaces.STM32.Bit;
   subtype CSR_JSTRT3_Field is Interfaces.STM32.Bit;
   subtype CSR_STRT3_Field is Interfaces.STM32.Bit;
   subtype CSR_OVR3_Field is Interfaces.STM32.Bit;
   ...
   subtype CCR_DDS_Field is Interfaces.STM32.Bit;
   subtype CCR_DMA_Field is Interfaces.STM32.UInt2;
   subtype CCR_ADCPRE_Field is Interfaces.STM32.UInt2;
   subtype CCR_VBATE_Field is Interfaces.STM32.Bit;
   subtype CCR_TSVREFE_Field is Interfaces.STM32.Bit;
   ...
   type ADC1_Peripheral is record
      ...
      SMPR1 : aliased Interfaces.STM32.UInt32;
      --  sample time register 2
      SMPR2 : aliased Interfaces.STM32.UInt32;
      --  injected channel data offset register x
