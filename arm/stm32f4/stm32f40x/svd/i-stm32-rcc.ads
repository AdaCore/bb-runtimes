...
package Interfaces.STM32.RCC is
   ...
   subtype AHB3RSTR_FSMCRST_Field is Bit;
   ...
   subtype AHB3ENR_FSMCEN_Field is Bit;
   ...
   subtype AHB3LPENR_FSMCLPEN_Field is Bit;
   ...
   subtype PLLI2SCFGR_PLLI2SNx_Field is UInt9;
   subtype PLLI2SCFGR_PLLI2SRx_Field is UInt3;
