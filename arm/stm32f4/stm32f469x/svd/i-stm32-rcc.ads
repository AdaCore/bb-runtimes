...
package Interfaces.STM32.RCC is
   ...
   subtype PLLCFGR_PLLR_Field is UInt3;
   ...
   subtype APB2RSTR_SDIORST_Field is Bit;
   ...
   subtype APB2RSTR_DSIRST_Field is Bit;
   ...
   subtype APB2ENR_SDIOEN_Field is Bit;
   ...
   subtype APB2ENR_DSIEN_Field is Bit;
   ...
   subtype APB2LPENR_SDIOLPEN_Field is Bit;
   ...
   subtype APB2LPENR_DSILPEN_Field is Bit;
   ...
   subtype BDCR_LSEMOD_Field is Bit;
   ...
   subtype DCKCFGR_PLLIS2DIVQ_Field is UInt5;
   subtype DCKCFGR_PLLSAIDIVQ_Field is UInt5;
   subtype DCKCFGR_PLLSAIDIVR_Field is UInt2;
   subtype DCKCFGR_SAI1ASRC_Field is UInt2;
   subtype DCKCFGR_SAI1BSRC_Field is UInt2;
   subtype DCKCFGR_TIMPRE_Field is Bit;
   subtype DCKCFGR_MSEL_Field is Bit;
   subtype DCKCFGR_SDMMCSEL_Field is Bit;
   subtype DCKCFGR_DSISEL_Field is Bit;
