...
package Interfaces.SAM.EFC is
   ...
   subtype EFC_EEFC_FMR_FRDY_Field is Interfaces.SAM.Bit;
   subtype EFC_EEFC_FMR_FWS_Field is Interfaces.SAM.UInt4;
   subtype EFC_EEFC_FMR_SCOD_Field is Interfaces.SAM.Bit;
   subtype EFC_EEFC_FMR_CLOE_Field is Interfaces.SAM.Bit;

   --  EEFC Flash Mode Register
   type EFC_EEFC_FMR_Register is record
      --  Flash Ready Interrupt Enable
      FRDY           : EFC_EEFC_FMR_FRDY_Field := 16#0#;
      --  unspecified
      ...
      SCOD           : EFC_EEFC_FMR_SCOD_Field := 16#0#;
      --  unspecified
      Reserved_17_25 : Interfaces.SAM.UInt9 := 16#0#;
      --  Code Loop Optimization Enable
      CLOE           : EFC_EEFC_FMR_CLOE_Field := 16#0#;
      --  unspecified
   ...
   subtype EFC_EEFC_FCR_FARG_Field is Interfaces.SAM.UInt16;
   ...
   type EFC_EEFC_FCR_Register is record
      ...
      FCMD : EEFC_FCR_FCMD_Field := Interfaces.SAM.EFC.Getd;
   ...
   subtype EFC_EEFC_FSR_FRDY_Field is Interfaces.SAM.Bit;
   subtype EFC_EEFC_FSR_FCMDE_Field is Interfaces.SAM.Bit;
   subtype EFC_EEFC_FSR_FLOCKE_Field is Interfaces.SAM.Bit;
   subtype EFC_EEFC_FSR_FLERR_Field is Interfaces.SAM.Bit;
   subtype EFC_EEFC_FSR_UECCELSB_Field is Interfaces.SAM.Bit;
   subtype EFC_EEFC_FSR_MECCELSB_Field is Interfaces.SAM.Bit;
   subtype EFC_EEFC_FSR_UECCEMSB_Field is Interfaces.SAM.Bit;
   subtype EFC_EEFC_FSR_MECCEMSB_Field is Interfaces.SAM.Bit;

   --  EEFC Flash Status Register
   type EFC_EEFC_FSR_Register is record
      --  Read-only. Flash Ready Status (cleared when Flash is busy)
      FRDY           : EFC_EEFC_FSR_FRDY_Field;
      --  Read-only. Flash Command Error Status (cleared on read or by writing
      --  EEFC_FCR)
      FCMDE          : EFC_EEFC_FSR_FCMDE_Field;
      --  Read-only. Flash Lock Error Status (cleared on read)
      FLOCKE         : EFC_EEFC_FSR_FLOCKE_Field;
      --  Read-only. Flash Error Status (cleared when a programming operation
      --  starts)
      FLERR          : EFC_EEFC_FSR_FLERR_Field;
      --  unspecified
      Reserved_4_15  : Interfaces.SAM.UInt12;
      --  Read-only. Unique ECC Error on LSB Part of the Memory Flash Data Bus
      --  (cleared on read)
      UECCELSB       : EFC_EEFC_FSR_UECCELSB_Field;
      --  Read-only. Multiple ECC Error on LSB Part of the Memory Flash Data
      --  Bus (cleared on read)
      MECCELSB       : EFC_EEFC_FSR_MECCELSB_Field;
      --  Read-only. Unique ECC Error on MSB Part of the Memory Flash Data Bus
      --  (cleared on read)
      UECCEMSB       : EFC_EEFC_FSR_UECCEMSB_Field;
      --  Read-only. Multiple ECC Error on MSB Part of the Memory Flash Data
      --  Bus (cleared on read)
      MECCEMSB       : EFC_EEFC_FSR_MECCEMSB_Field;
      --  unspecified
   ...
   subtype EFC_EEFC_VERSION_VERSION_Field is Interfaces.SAM.UInt12;
   subtype EFC_EEFC_VERSION_MFN_Field is Interfaces.SAM.UInt3;
   ...
   subtype EFC_EEFC_WPMR_WPEN_Field is Interfaces.SAM.Bit;
   ...
   type EFC_EEFC_WPMR_Register is record
      ...
      WPEN         : EFC_EEFC_WPMR_WPEN_Field := 16#0#;
      --  unspecified
      Reserved_1_7 : Interfaces.SAM.UInt7 := 16#0#;
      --  Write Protection Key
   ...
   type EFC_Peripheral is record
      ...
      EEFC_FRR     : aliased Interfaces.SAM.UInt32;
      --  EEFC Version Register
