...
--  This spec has been automatically generated from ATSAM.svd
...
package Interfaces.SAM.SYSC is
   ...
   subtype RTC_SR_ACKUPD_Field is Interfaces.SAM.Bit;
   subtype RTC_SR_ALARM_Field is Interfaces.SAM.Bit;
   subtype RTC_SR_SEC_Field is Interfaces.SAM.Bit;
   subtype RTC_SR_TIMEV_Field is Interfaces.SAM.Bit;
   subtype RTC_SR_CALEV_Field is Interfaces.SAM.Bit;
...
--  occurs.
   ...
   type SUPC_SMMR_Register is record
      ...
      SMRSTEN        : SMMR_SMRSTEN_Field :=
                        Interfaces.SAM.SYSC.Not_Enable;
      --  Supply Monitor Interrupt Enable
...
--  occurs.
   ...
   subtype SUPC_MR_VDDIORDYONREG_Field is Interfaces.SAM.Bit;
