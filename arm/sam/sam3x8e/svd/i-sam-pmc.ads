...
package Interfaces.SAM.PMC is
   ...
   subtype PMC_SCER_UOTGCLK_Field is Interfaces.SAM.Bit;
   ...
   subtype PMC_SCDR_UOTGCLK_Field is Interfaces.SAM.Bit;
   ...
   subtype PMC_SCSR_UOTGCLK_Field is Interfaces.SAM.Bit;
   ...
   type PMC_SCSR_Register is record
      --  unspecified
      Reserved_0_4   : Interfaces.SAM.UInt5;
   ...
   subtype CKGR_UCKR_UPLLEN_Field is Interfaces.SAM.Bit;
   subtype CKGR_UCKR_UPLLCOUNT_Field is Interfaces.SAM.UInt4;

   --  UTMI Clock Register
   type CKGR_UCKR_Register is record
      --  unspecified
      Reserved_0_15  : Interfaces.SAM.UInt16 := 16#800#;
      --  UTMI PLL Enable
      ...
      --  unspecified
      Reserved_24_31 : Interfaces.SAM.Byte := 16#10#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CKGR_MOR_KEY_Field is Interfaces.SAM.Byte;
   ...
   type CKGR_MOR_Register is record
      ...
      MOSCRCF        : CKGR_MOR_MOSCRCF_Field :=
                        Interfaces.SAM.PMC.Val_12_Mhz;
--                        Interfaces.SAM.PMC.Val_4_Mhz;
      --  unspecified
   ...
   subtype PMC_MCKR_UPLLDIV2_Field is Interfaces.SAM.Bit;
   ...
   type PMC_PCK_Register is record
      ...
      --  Programmable Clock Prescaler
      PRES          : PMC_PCK_PRES_Field := Interfaces.SAM.PMC.Clk_1;
      --  unspecified
   ...
   subtype PMC_IER_LOCKU_Field is Interfaces.SAM.Bit;
   ...
   subtype PMC_IDR_LOCKU_Field is Interfaces.SAM.Bit;
   ...
   subtype PMC_SR_LOCKU_Field is Interfaces.SAM.Bit;
   ...
   subtype PMC_IMR_LOCKU_Field is Interfaces.SAM.Bit;
   ...
   type PMC_PCR_Register is record
      ...
      DIV            : PMC_PCR_DIV_Field :=
                        Interfaces.SAM.PMC.Periph_Div_Mck;
      --  unspecified
