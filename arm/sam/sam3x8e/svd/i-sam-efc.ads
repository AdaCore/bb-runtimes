...
package Interfaces.SAM.EFC is
   ...
   subtype EFC0_FMR_FRDY_Field is Interfaces.SAM.Bit;
   subtype EFC0_FMR_FWS_Field is Interfaces.SAM.UInt4;
   subtype EFC0_FMR_SCOD_Field is Interfaces.SAM.Bit;
   subtype EFC0_FMR_FAM_Field is Interfaces.SAM.Bit;
...
--  no action is started.
   ...
   subtype EFC0_FSR_FRDY_Field is Interfaces.SAM.Bit;
   subtype EFC0_FSR_FCMDE_Field is Interfaces.SAM.Bit;
   subtype EFC0_FSR_FLOCKE_Field is Interfaces.SAM.Bit;
