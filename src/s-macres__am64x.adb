...
package body System.Machine_Reset is
   ...
   procedure Os_Exit (Status : Integer) is
      ...
      CTRLMMR_RST_CTRL : Interfaces.Unsigned_32 with
         Volatile, Import, Address => System'To_Address (16#4301_8170#);
      --  Defined in AM64x Technical Reference Manual section 5.3.5.2.2
   begin
      loop
         CTRLMMR_RST_CTRL := 6;
         --  Setting field SW_MAIN_WARMRST to 0b0110 causing a warm reset
      end loop;
   end Os_Exit;
