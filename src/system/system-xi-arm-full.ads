...
package System is
   ...
   --  241 - 242  correspond to IRQ and FIQ interrupt levels respectively
   --  242        is the priority value that block all interrupts
   ...
   subtype Any_Priority       is Integer      range   0 .. 242;
   subtype Priority           is Any_Priority range   0 .. 240;
   subtype Interrupt_Priority is Any_Priority range 241 .. 242;
