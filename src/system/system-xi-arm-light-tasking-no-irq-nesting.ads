...
package System is
   ...
   --  241        corresponds to IRQ interrupt level
   --  241        is the priority value that block all interrupts
   ...
   Max_Interrupt_Priority : constant Positive := 241;

   subtype Any_Priority       is Integer      range   0 .. 241;
   subtype Priority           is Any_Priority range   0 .. 240;
   subtype Interrupt_Priority is Any_Priority range 241 .. 241;
