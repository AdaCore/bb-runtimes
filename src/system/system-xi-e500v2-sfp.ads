...
package System is
   ...
   --  The OpenPIC has 16 interrupt priority levels, plus 1 for the decrementer
   Nbr_Interrupt_Priorities : constant Positive := 17;
   Max_Interrupt_Priority   : constant Positive := 255;
   Max_Priority             : constant Positive :=
     Max_Interrupt_Priority - Nbr_Interrupt_Priorities;
