...
package System is
   ...
   --  PikeOS APEX priorities are 1 .. 63
   ...
   Default_Priority : constant Priority := 32;
...
private
   ...
   pragma Linker_Options
      ("-u_begin" & ASCII.NUL & "-e_begin" & ASCII.NUL &
       "-uMAIN" & ASCII.NUL & "-T../scripts/app-ld-script" & ASCII.NUL &
       "-lvm" & ASCII.NUL &
       "-lp4" & ASCII.NUL & "-lstand");
   --  Select the appropriate entry point, linker script, and libraries for
   --  a PikeOS partition using the APEX interface.
