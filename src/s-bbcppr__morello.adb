...
package body System.BB.CPU_Primitives is
   ...
   is
      ...
      Minimum_Stack_Size_In_Bytes : constant Storage_Elements.Storage_Offset :=
                                      CPU_Specific.Stack_Alignment;
   begin
      --  ??? Force alignment
      Stack_Pointer := (Base + Size) - Minimum_Stack_Size_In_Bytes;
   ...
   begin
      ...
      Buffer.CSP := Initial_SP;
      Buffer.C30 := Start_Thread_Asm'Address;

      Buffer.C19 := Program_Counter;
      Buffer.C20 := Argument;
