...
package Interfaces.SAM.PMC is
   ...
   subtype PMC_PMC_SCER_USBCLK_Field is Interfaces.SAM.Bit;
   --  PMC_PMC_SCER_PCK array element
   subtype PMC_PMC_SCER_PCK_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SCER_PCK array
   type PMC_PMC_SCER_PCK_Field_Array is array (0 .. 6)
     of PMC_PMC_SCER_PCK_Element
   ...
   type PMC_PMC_SCER_Register is record
      --  unspecified
      Reserved_0_4   : Interfaces.SAM.UInt5 := 16#0#;
      --  Write-only. Enable USB FS Clock
      USBCLK         : PMC_PMC_SCER_USBCLK_Field := 16#0#;
      --  unspecified
   ...
   subtype PMC_PMC_SCDR_USBCLK_Field is Interfaces.SAM.Bit;
   --  PMC_PMC_SCDR_PCK array element
   subtype PMC_PMC_SCDR_PCK_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SCDR_PCK array
   type PMC_PMC_SCDR_PCK_Field_Array is array (0 .. 6)
     of PMC_PMC_SCDR_PCK_Element
     with Component_Size => 1, Size => 7;
   ...
   type PMC_PMC_SCDR_Register is record
      ...
      USBCLK         : PMC_PMC_SCDR_USBCLK_Field := 16#0#;
      --  unspecified
      Reserved_6_7   : Interfaces.SAM.UInt2 := 16#0#;
   ...
   subtype PMC_PMC_SCSR_HCLKS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_SCSR_USBCLK_Field is Interfaces.SAM.Bit;
   --  PMC_PMC_SCSR_PCK array element
   subtype PMC_PMC_SCSR_PCK_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SCSR_PCK array
   type PMC_PMC_SCSR_PCK_Field_Array is array (0 .. 6)
     of PMC_PMC_SCSR_PCK_Element
     with Component_Size => 1, Size => 7;
   ...
   type PMC_PMC_SCSR_Register is record
      ...
      HCLKS          : PMC_PMC_SCSR_HCLKS_Field;
      --  unspecified
      Reserved_1_4   : Interfaces.SAM.UInt4;
      --  Read-only. USB FS Clock Status
      USBCLK         : PMC_PMC_SCSR_USBCLK_Field;
      --  unspecified
   ...
   --  PMC_PMC_PCER0_PID array element
   subtype PMC_PMC_PCER0_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_PCER0_PID array
   type PMC_PMC_PCER0_PID_Field_Array is array (7 .. 31)
     of PMC_PMC_PCER0_PID_Element
   ...
   --  PMC_PMC_PCDR0_PID array element
   subtype PMC_PMC_PCDR0_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_PCDR0_PID array
   type PMC_PMC_PCDR0_PID_Field_Array is array (7 .. 31)
     of PMC_PMC_PCDR0_PID_Element
     with Component_Size => 1, Size => 25;
   ...
   --  PMC_PMC_PCSR0_PID array element
   subtype PMC_PMC_PCSR0_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_PCSR0_PID array
   type PMC_PMC_PCSR0_PID_Field_Array is array (7 .. 31)
     of PMC_PMC_PCSR0_PID_Element
     with Component_Size => 1, Size => 25;
   ...
   subtype PMC_CKGR_UCKR_UPLLEN_Field is Interfaces.SAM.Bit;
   subtype PMC_CKGR_UCKR_UPLLCOUNT_Field is Interfaces.SAM.UInt4;
   ...
   type PMC_CKGR_UCKR_Register is record
      ...
      --  UTMI PLL Enable
      UPLLEN         : PMC_CKGR_UCKR_UPLLEN_Field := 16#0#;
      --  unspecified
   ...
   subtype PMC_CKGR_MOR_WAITMODE_Field is Interfaces.SAM.Bit;
   ...
   subtype PMC_CKGR_MOR_XT32KFME_Field is Interfaces.SAM.Bit;
   ...
   type PMC_CKGR_MOR_Register is record
      ...
      WAITMODE       : PMC_CKGR_MOR_WAITMODE_Field := 16#0#;
      ...
      XT32KFME       : PMC_CKGR_MOR_XT32KFME_Field := 16#0#;
      --  unspecified
   ...
   subtype PMC_CKGR_PLLAR_DIVA_Field is Interfaces.SAM.Byte;
   ...
   subtype PMC_PMC_MCKR_UPLLDIV2_Field is Interfaces.SAM.Bit;

   --  Master Clock Register
   type PMC_PMC_MCKR_Register is record
      --  Master Clock Source Selection
      CSS            : PMC_MCKR_CSS_Field := Interfaces.SAM.PMC.Slow_Clk;
      --  unspecified
      ...
      Reserved_7_7   : Interfaces.SAM.Bit := 16#0#;
      --  Master Clock Division
      MDIV           : PMC_MCKR_MDIV_Field := Interfaces.SAM.PMC.Eq_Pck;
      --  unspecified
      Reserved_10_12 : Interfaces.SAM.UInt3 := 16#0#;
      --  UPLL Divider by 2
      UPLLDIV2       : PMC_PMC_MCKR_UPLLDIV2_Field := 16#0#;
      --  unspecified
   ...
   subtype PMC_PMC_USB_USBS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_USB_USBDIV_Field is Interfaces.SAM.UInt4;

   --  USB Clock Register
   type PMC_PMC_USB_Register is record
      --  USB Input Clock Selection
      USBS           : PMC_PMC_USB_USBS_Field := 16#0#;
      --  unspecified
   ...
   subtype PMC_PMC_PCK_PRES_Field is Interfaces.SAM.Byte;
   ...
   subtype PMC_PMC_IER_MOSCXTS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IER_LOCKA_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IER_MCKRDY_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IER_LOCKU_Field is Interfaces.SAM.Bit;
   --  PMC_PMC_IER_PCKRDY array element
   subtype PMC_PMC_IER_PCKRDY_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_IER_PCKRDY array
   type PMC_PMC_IER_PCKRDY_Field_Array is array (0 .. 6)
     of PMC_PMC_IER_PCKRDY_Element
     with Component_Size => 1, Size => 7;
   ...
   subtype PMC_PMC_IER_MOSCSELS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IER_MOSCRCS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IER_CFDEV_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IER_XT32KERR_Field is Interfaces.SAM.Bit;

   --  Interrupt Enable Register
   type PMC_PMC_IER_Register is record
      --  Write-only. Main Crystal Oscillator Status Interrupt Enable
      MOSCXTS        : PMC_PMC_IER_MOSCXTS_Field := 16#0#;
      --  Write-only. PLLA Lock Interrupt Enable
      LOCKA          : PMC_PMC_IER_LOCKA_Field := 16#0#;
      --  unspecified
      Reserved_2_2   : Interfaces.SAM.Bit := 16#0#;
      --  Write-only. Master Clock Ready Interrupt Enable
      MCKRDY         : PMC_PMC_IER_MCKRDY_Field := 16#0#;
      --  unspecified
      Reserved_4_5   : Interfaces.SAM.UInt2 := 16#0#;
      --  Write-only. UTMI PLL Lock Interrupt Enable
      LOCKU          : PMC_PMC_IER_LOCKU_Field := 16#0#;
      --  unspecified
      Reserved_7_7   : Interfaces.SAM.Bit := 16#0#;
   ...
   subtype PMC_PMC_IDR_MOSCXTS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IDR_LOCKA_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IDR_MCKRDY_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IDR_LOCKU_Field is Interfaces.SAM.Bit;
   --  PMC_PMC_IDR_PCKRDY array element
   subtype PMC_PMC_IDR_PCKRDY_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_IDR_PCKRDY array
   type PMC_PMC_IDR_PCKRDY_Field_Array is array (0 .. 6)
     of PMC_PMC_IDR_PCKRDY_Element
     with Component_Size => 1, Size => 7;
   ...
   subtype PMC_PMC_IDR_MOSCSELS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IDR_MOSCRCS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IDR_CFDEV_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IDR_XT32KERR_Field is Interfaces.SAM.Bit;

   --  Interrupt Disable Register
   type PMC_PMC_IDR_Register is record
      --  Write-only. Main Crystal Oscillator Status Interrupt Disable
      MOSCXTS        : PMC_PMC_IDR_MOSCXTS_Field := 16#0#;
      --  Write-only. PLLA Lock Interrupt Disable
      LOCKA          : PMC_PMC_IDR_LOCKA_Field := 16#0#;
      --  unspecified
      Reserved_2_2   : Interfaces.SAM.Bit := 16#0#;
      --  Write-only. Master Clock Ready Interrupt Disable
      MCKRDY         : PMC_PMC_IDR_MCKRDY_Field := 16#0#;
      --  unspecified
      Reserved_4_5   : Interfaces.SAM.UInt2 := 16#0#;
      --  Write-only. UTMI PLL Lock Interrupt Disable
      LOCKU          : PMC_PMC_IDR_LOCKU_Field := 16#0#;
      --  unspecified
      Reserved_7_7   : Interfaces.SAM.Bit := 16#0#;
   ...
   subtype PMC_PMC_SR_MOSCXTS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_SR_LOCKA_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_SR_MCKRDY_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_SR_LOCKU_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_SR_OSCSELS_Field is Interfaces.SAM.Bit;
   --  PMC_PMC_SR_PCKRDY array element
   subtype PMC_PMC_SR_PCKRDY_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SR_PCKRDY array
   type PMC_PMC_SR_PCKRDY_Field_Array is array (0 .. 6)
     of PMC_PMC_SR_PCKRDY_Element
     with Component_Size => 1, Size => 7;
   ...
   subtype PMC_PMC_SR_MOSCSELS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_SR_MOSCRCS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_SR_CFDEV_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_SR_CFDS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_SR_FOS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_SR_XT32KERR_Field is Interfaces.SAM.Bit;

   --  Status Register
   type PMC_PMC_SR_Register is record
      --  Read-only. Main Crystal Oscillator Status
      MOSCXTS        : PMC_PMC_SR_MOSCXTS_Field;
      --  Read-only. PLLA Lock Status
      LOCKA          : PMC_PMC_SR_LOCKA_Field;
      --  unspecified
      Reserved_2_2   : Interfaces.SAM.Bit;
      --  Read-only. Master Clock Status
      MCKRDY         : PMC_PMC_SR_MCKRDY_Field;
      --  unspecified
      Reserved_4_5   : Interfaces.SAM.UInt2;
      --  Read-only. UTMI PLL Lock Status
      LOCKU          : PMC_PMC_SR_LOCKU_Field;
      --  Read-only. Slow Clock Source Oscillator Selection
      OSCSELS        : PMC_PMC_SR_OSCSELS_Field;
   ...
   subtype PMC_PMC_IMR_MOSCXTS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IMR_LOCKA_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IMR_MCKRDY_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IMR_LOCKU_Field is Interfaces.SAM.Bit;
   --  PMC_PMC_IMR_PCKRDY array element
   subtype PMC_PMC_IMR_PCKRDY_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_IMR_PCKRDY array
   type PMC_PMC_IMR_PCKRDY_Field_Array is array (0 .. 6)
     of PMC_PMC_IMR_PCKRDY_Element
     with Component_Size => 1, Size => 7;
   ...
   subtype PMC_PMC_IMR_MOSCSELS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IMR_MOSCRCS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IMR_CFDEV_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_IMR_XT32KERR_Field is Interfaces.SAM.Bit;

   --  Interrupt Mask Register
   type PMC_PMC_IMR_Register is record
      --  Read-only. Main Crystal Oscillator Status Interrupt Mask
      MOSCXTS        : PMC_PMC_IMR_MOSCXTS_Field;
      --  Read-only. PLLA Lock Interrupt Mask
      LOCKA          : PMC_PMC_IMR_LOCKA_Field;
      --  unspecified
      Reserved_2_2   : Interfaces.SAM.Bit;
      --  Read-only. Master Clock Ready Interrupt Mask
      MCKRDY         : PMC_PMC_IMR_MCKRDY_Field;
      --  unspecified
      Reserved_4_5   : Interfaces.SAM.UInt2;
      --  Read-only. UTMI PLL Lock Interrupt Mask
      LOCKU          : PMC_PMC_IMR_LOCKU_Field;
      --  unspecified
   ...
   --  PMC_PMC_FSMR_FSTT array element
   subtype PMC_PMC_FSMR_FSTT_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_FSMR_FSTT array
   type PMC_PMC_FSMR_FSTT_Field_Array is array (0 .. 15)
     of PMC_PMC_FSMR_FSTT_Element
   ...
   subtype PMC_PMC_FSMR_RTTAL_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_FSMR_RTCAL_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_FSMR_USBAL_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_FSMR_LPM_Field is Interfaces.SAM.Bit;
   ...
   subtype PMC_PMC_FSMR_FFLPM_Field is Interfaces.SAM.Bit;
   ...
   type PMC_PMC_FSMR_Register is record
      ...
      FSTT           : PMC_PMC_FSMR_FSTT_Field :=
                        (As_Array => False, Val => 16#0#);
      --  RTT Alarm Enable
      RTTAL          : PMC_PMC_FSMR_RTTAL_Field := 16#0#;
      --  RTC Alarm Enable
      RTCAL          : PMC_PMC_FSMR_RTCAL_Field := 16#0#;
      --  USB Alarm Enable
      USBAL          : PMC_PMC_FSMR_USBAL_Field := 16#0#;
      --  unspecified
      Reserved_19_19 : Interfaces.SAM.Bit := 16#0#;
      --  Low-power Mode
      LPM            : PMC_PMC_FSMR_LPM_Field := 16#0#;
      --  Flash Low-power Mode
      FLPM           : PMC_FSMR_FLPM_Field :=
                        Interfaces.SAM.PMC.Flash_Standby;
      --  Force Flash Low-power Mode
      FFLPM          : PMC_PMC_FSMR_FFLPM_Field := 16#0#;
      --  unspecified
      Reserved_24_31 : Interfaces.SAM.Byte := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   --  PMC_PMC_FSPR_FSTP array element
   subtype PMC_PMC_FSPR_FSTP_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_FSPR_FSTP array
   type PMC_PMC_FSPR_FSTP_Field_Array is array (0 .. 15)
     of PMC_PMC_FSPR_FSTP_Element
     with Component_Size => 1, Size => 16;
   ...
   subtype PMC_PMC_WPMR_WPEN_Field is Interfaces.SAM.Bit;
   ...
   type PMC_PMC_WPMR_Register is record
      ...
      WPEN         : PMC_PMC_WPMR_WPEN_Field := 16#0#;
      --  unspecified
      Reserved_1_7 : Interfaces.SAM.UInt7 := 16#0#;
      --  Write Protection Key
   ...
   subtype PMC_PMC_WPSR_WPVS_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_WPSR_WPVSRC_Field is Interfaces.SAM.UInt16;

   --  Write Protection Status Register
   type PMC_PMC_WPSR_Register is record
      --  Read-only. Write Protection Violation Status
      WPVS           : PMC_PMC_WPSR_WPVS_Field;
      --  unspecified
   ...
   subtype PMC_PMC_VERSION_VERSION_Field is Interfaces.SAM.UInt12;
   subtype PMC_PMC_VERSION_MFN_Field is Interfaces.SAM.UInt3;
   ...
   --  PMC_PMC_PCER1_PID array element
   subtype PMC_PMC_PCER1_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_PCER1_PID array
   type PMC_PMC_PCER1_PID_Field_Array is array (32 .. 35)
     of PMC_PMC_PCER1_PID_Element
   ...
   subtype PMC_PMC_PCER1_PID37_Field is Interfaces.SAM.Bit;

   --  PMC_PMC_PCER1_PID array
   type PMC_PMC_PCER1_PID_Field_Array_1 is array (39 .. 53)
     of PMC_PMC_PCER1_PID_Element
   ...
   --  PMC_PMC_PCER1_PID array
   type PMC_PMC_PCER1_PID_Field_Array_2 is array (56 .. 60)
     of PMC_PMC_PCER1_PID_Element
   ...
   type PMC_PMC_PCER1_Register is record
      ...
      PID37          : PMC_PMC_PCER1_PID37_Field := 16#0#;
      --  unspecified
   ...
   --  PMC_PMC_PCDR1_PID array element
   subtype PMC_PMC_PCDR1_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_PCDR1_PID array
   type PMC_PMC_PCDR1_PID_Field_Array is array (32 .. 35)
     of PMC_PMC_PCDR1_PID_Element
     with Component_Size => 1, Size => 4;
   ...
   subtype PMC_PMC_PCDR1_PID37_Field is Interfaces.SAM.Bit;

   --  PMC_PMC_PCDR1_PID array
   type PMC_PMC_PCDR1_PID_Field_Array_1 is array (39 .. 53)
     of PMC_PMC_PCDR1_PID_Element
     with Component_Size => 1, Size => 15;
   ...
   --  PMC_PMC_PCDR1_PID array
   type PMC_PMC_PCDR1_PID_Field_Array_2 is array (56 .. 60)
     of PMC_PMC_PCDR1_PID_Element
     with Component_Size => 1, Size => 5;
   ...
   type PMC_PMC_PCDR1_Register is record
      ...
      PID37          : PMC_PMC_PCDR1_PID37_Field := 16#0#;
      --  unspecified
      Reserved_6_6   : Interfaces.SAM.Bit := 16#0#;
   ...
   --  PMC_PMC_PCSR1_PID array element
   subtype PMC_PMC_PCSR1_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_PCSR1_PID array
   type PMC_PMC_PCSR1_PID_Field_Array is array (32 .. 35)
     of PMC_PMC_PCSR1_PID_Element
     with Component_Size => 1, Size => 4;
   ...
   subtype PMC_PMC_PCSR1_PID37_Field is Interfaces.SAM.Bit;

   --  PMC_PMC_PCSR1_PID array
   type PMC_PMC_PCSR1_PID_Field_Array_1 is array (39 .. 53)
     of PMC_PMC_PCSR1_PID_Element
     with Component_Size => 1, Size => 15;
   ...
   --  PMC_PMC_PCSR1_PID array
   type PMC_PMC_PCSR1_PID_Field_Array_2 is array (56 .. 60)
     of PMC_PMC_PCSR1_PID_Element
     with Component_Size => 1, Size => 5;
   ...
   type PMC_PMC_PCSR1_Register is record
      ...
      PID37          : PMC_PMC_PCSR1_PID37_Field;
      --  unspecified
   ...
   subtype PMC_PMC_PCR_PID_Field is Interfaces.SAM.UInt7;
   ...
   subtype PMC_PMC_PCR_CMD_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_PCR_GCLKDIV_Field is Interfaces.SAM.Byte;
   subtype PMC_PMC_PCR_EN_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_PCR_GCLKEN_Field is Interfaces.SAM.Bit;
   ...
   subtype PMC_PMC_OCR_CAL4_Field is Interfaces.SAM.UInt7;
   subtype PMC_PMC_OCR_SEL4_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_OCR_CAL8_Field is Interfaces.SAM.UInt7;
   subtype PMC_PMC_OCR_SEL8_Field is Interfaces.SAM.Bit;
   subtype PMC_PMC_OCR_CAL12_Field is Interfaces.SAM.UInt7;
   subtype PMC_PMC_OCR_SEL12_Field is Interfaces.SAM.Bit;
   ...
   type PMC_PMC_OCR_Register is record
      ...
      SEL4           : PMC_PMC_OCR_SEL4_Field := 16#0#;
      ...
      SEL8           : PMC_PMC_OCR_SEL8_Field := 16#0#;
      ...
      SEL12          : PMC_PMC_OCR_SEL12_Field := 16#0#;
      --  unspecified
      Reserved_24_31 : Interfaces.SAM.Byte := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   --  PMC_PMC_SLPWK_ER0_PID array element
   subtype PMC_PMC_SLPWK_ER0_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_ER0_PID array
   type PMC_PMC_SLPWK_ER0_PID_Field_Array is array (7 .. 31)
     of PMC_PMC_SLPWK_ER0_PID_Element
     with Component_Size => 1, Size => 25;
   ...
   --  PMC_PMC_SLPWK_DR0_PID array element
   subtype PMC_PMC_SLPWK_DR0_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_DR0_PID array
   type PMC_PMC_SLPWK_DR0_PID_Field_Array is array (7 .. 31)
     of PMC_PMC_SLPWK_DR0_PID_Element
     with Component_Size => 1, Size => 25;
   ...
   --  PMC_PMC_SLPWK_SR0_PID array element
   subtype PMC_PMC_SLPWK_SR0_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_SR0_PID array
   type PMC_PMC_SLPWK_SR0_PID_Field_Array is array (7 .. 31)
     of PMC_PMC_SLPWK_SR0_PID_Element
     with Component_Size => 1, Size => 25;
   ...
   --  PMC_PMC_SLPWK_ASR0_PID array element
   subtype PMC_PMC_SLPWK_ASR0_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_ASR0_PID array
   type PMC_PMC_SLPWK_ASR0_PID_Field_Array is array (7 .. 31)
     of PMC_PMC_SLPWK_ASR0_PID_Element
     with Component_Size => 1, Size => 25;
   ...
   subtype PMC_PMC_PMMR_PLLA_MMAX_Field is Interfaces.SAM.UInt11;
   ...
   --  PMC_PMC_SLPWK_ER1_PID array element
   subtype PMC_PMC_SLPWK_ER1_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_ER1_PID array
   type PMC_PMC_SLPWK_ER1_PID_Field_Array is array (32 .. 35)
     of PMC_PMC_SLPWK_ER1_PID_Element
     with Component_Size => 1, Size => 4;
   ...
   subtype PMC_PMC_SLPWK_ER1_PID37_Field is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_ER1_PID array
   type PMC_PMC_SLPWK_ER1_PID_Field_Array_1 is array (39 .. 53)
     of PMC_PMC_SLPWK_ER1_PID_Element
     with Component_Size => 1, Size => 15;
   ...
   --  PMC_PMC_SLPWK_ER1_PID array
   type PMC_PMC_SLPWK_ER1_PID_Field_Array_2 is array (56 .. 60)
     of PMC_PMC_SLPWK_ER1_PID_Element
     with Component_Size => 1, Size => 5;
   ...
   type PMC_PMC_SLPWK_ER1_Register is record
      ...
      PID37          : PMC_PMC_SLPWK_ER1_PID37_Field := 16#0#;
      --  unspecified
      Reserved_6_6   : Interfaces.SAM.Bit := 16#0#;
   ...
   --  PMC_PMC_SLPWK_DR1_PID array element
   subtype PMC_PMC_SLPWK_DR1_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_DR1_PID array
   type PMC_PMC_SLPWK_DR1_PID_Field_Array is array (32 .. 35)
     of PMC_PMC_SLPWK_DR1_PID_Element
     with Component_Size => 1, Size => 4;
   ...
   subtype PMC_PMC_SLPWK_DR1_PID37_Field is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_DR1_PID array
   type PMC_PMC_SLPWK_DR1_PID_Field_Array_1 is array (39 .. 53)
     of PMC_PMC_SLPWK_DR1_PID_Element
     with Component_Size => 1, Size => 15;
   ...
   --  PMC_PMC_SLPWK_DR1_PID array
   type PMC_PMC_SLPWK_DR1_PID_Field_Array_2 is array (56 .. 60)
     of PMC_PMC_SLPWK_DR1_PID_Element
     with Component_Size => 1, Size => 5;
   ...
   type PMC_PMC_SLPWK_DR1_Register is record
      ...
      PID37          : PMC_PMC_SLPWK_DR1_PID37_Field := 16#0#;
      --  unspecified
      Reserved_6_6   : Interfaces.SAM.Bit := 16#0#;
   ...
   --  PMC_PMC_SLPWK_SR1_PID array element
   subtype PMC_PMC_SLPWK_SR1_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_SR1_PID array
   type PMC_PMC_SLPWK_SR1_PID_Field_Array is array (32 .. 35)
     of PMC_PMC_SLPWK_SR1_PID_Element
     with Component_Size => 1, Size => 4;
   ...
   subtype PMC_PMC_SLPWK_SR1_PID37_Field is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_SR1_PID array
   type PMC_PMC_SLPWK_SR1_PID_Field_Array_1 is array (39 .. 53)
     of PMC_PMC_SLPWK_SR1_PID_Element
     with Component_Size => 1, Size => 15;
   ...
   --  PMC_PMC_SLPWK_SR1_PID array
   type PMC_PMC_SLPWK_SR1_PID_Field_Array_2 is array (56 .. 60)
     of PMC_PMC_SLPWK_SR1_PID_Element
     with Component_Size => 1, Size => 5;
   ...
   type PMC_PMC_SLPWK_SR1_Register is record
      ...
      PID37          : PMC_PMC_SLPWK_SR1_PID37_Field;
      --  unspecified
      Reserved_6_6   : Interfaces.SAM.Bit;
   ...
   --  PMC_PMC_SLPWK_ASR1_PID array element
   subtype PMC_PMC_SLPWK_ASR1_PID_Element is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_ASR1_PID array
   type PMC_PMC_SLPWK_ASR1_PID_Field_Array is array (32 .. 35)
     of PMC_PMC_SLPWK_ASR1_PID_Element
     with Component_Size => 1, Size => 4;
   ...
   subtype PMC_PMC_SLPWK_ASR1_PID37_Field is Interfaces.SAM.Bit;

   --  PMC_PMC_SLPWK_ASR1_PID array
   type PMC_PMC_SLPWK_ASR1_PID_Field_Array_1 is array (39 .. 53)
     of PMC_PMC_SLPWK_ASR1_PID_Element
     with Component_Size => 1, Size => 15;
   ...
   --  PMC_PMC_SLPWK_ASR1_PID array
   type PMC_PMC_SLPWK_ASR1_PID_Field_Array_2 is array (56 .. 60)
     of PMC_PMC_SLPWK_ASR1_PID_Element
     with Component_Size => 1, Size => 5;
   ...
   type PMC_PMC_SLPWK_ASR1_Register is record
      ...
      PID37          : PMC_PMC_SLPWK_ASR1_PID37_Field;
      --  unspecified
      Reserved_6_6   : Interfaces.SAM.Bit;
   ...
   subtype PMC_PMC_APLLACR_DCOFLTSEL_Field is Interfaces.SAM.UInt4;
   subtype PMC_PMC_APLLACR_FLTSEL_Field is Interfaces.SAM.UInt4;
   subtype PMC_PMC_APLLACR_BIAS_Field is Interfaces.SAM.UInt2;
   ...
   subtype PMC_PMC_WMST_WMST_Field is Interfaces.SAM.Byte;
