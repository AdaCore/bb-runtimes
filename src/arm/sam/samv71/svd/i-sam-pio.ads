...
package Interfaces.SAM.PIO is
   ...
   --  PIO_PIO_PER_P array element
   subtype PIO_PIO_PER_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_PER_P array
   type PIO_PIO_PER_P_Field_Array is array (0 .. 31) of PIO_PIO_PER_P_Element
   ...
   --  PIO_PIO_PDR_P array element
   subtype PIO_PIO_PDR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_PDR_P array
   type PIO_PIO_PDR_P_Field_Array is array (0 .. 31) of PIO_PIO_PDR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_PSR_P array element
   subtype PIO_PIO_PSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_PSR_P array
   type PIO_PIO_PSR_P_Field_Array is array (0 .. 31) of PIO_PIO_PSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_OER_P array element
   subtype PIO_PIO_OER_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_OER_P array
   type PIO_PIO_OER_P_Field_Array is array (0 .. 31) of PIO_PIO_OER_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_ODR_P array element
   subtype PIO_PIO_ODR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_ODR_P array
   type PIO_PIO_ODR_P_Field_Array is array (0 .. 31) of PIO_PIO_ODR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_OSR_P array element
   subtype PIO_PIO_OSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_OSR_P array
   type PIO_PIO_OSR_P_Field_Array is array (0 .. 31) of PIO_PIO_OSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_IFER_P array element
   subtype PIO_PIO_IFER_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_IFER_P array
   type PIO_PIO_IFER_P_Field_Array is array (0 .. 31)
     of PIO_PIO_IFER_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_IFDR_P array element
   subtype PIO_PIO_IFDR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_IFDR_P array
   type PIO_PIO_IFDR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_IFDR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_IFSR_P array element
   subtype PIO_PIO_IFSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_IFSR_P array
   type PIO_PIO_IFSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_IFSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_SODR_P array element
   subtype PIO_PIO_SODR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_SODR_P array
   type PIO_PIO_SODR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_SODR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_CODR_P array element
   subtype PIO_PIO_CODR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_CODR_P array
   type PIO_PIO_CODR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_CODR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_ODSR_P array element
   subtype PIO_PIO_ODSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_ODSR_P array
   type PIO_PIO_ODSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_ODSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_PDSR_P array element
   subtype PIO_PIO_PDSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_PDSR_P array
   type PIO_PIO_PDSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_PDSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_IER_P array element
   subtype PIO_PIO_IER_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_IER_P array
   type PIO_PIO_IER_P_Field_Array is array (0 .. 31) of PIO_PIO_IER_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_IDR_P array element
   subtype PIO_PIO_IDR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_IDR_P array
   type PIO_PIO_IDR_P_Field_Array is array (0 .. 31) of PIO_PIO_IDR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_IMR_P array element
   subtype PIO_PIO_IMR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_IMR_P array
   type PIO_PIO_IMR_P_Field_Array is array (0 .. 31) of PIO_PIO_IMR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_ISR_P array element
   subtype PIO_PIO_ISR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_ISR_P array
   type PIO_PIO_ISR_P_Field_Array is array (0 .. 31) of PIO_PIO_ISR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_MDER_P array element
   subtype PIO_PIO_MDER_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_MDER_P array
   type PIO_PIO_MDER_P_Field_Array is array (0 .. 31)
     of PIO_PIO_MDER_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_MDDR_P array element
   subtype PIO_PIO_MDDR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_MDDR_P array
   type PIO_PIO_MDDR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_MDDR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_MDSR_P array element
   subtype PIO_PIO_MDSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_MDSR_P array
   type PIO_PIO_MDSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_MDSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_PUDR_P array element
   subtype PIO_PIO_PUDR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_PUDR_P array
   type PIO_PIO_PUDR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_PUDR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_PUER_P array element
   subtype PIO_PIO_PUER_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_PUER_P array
   type PIO_PIO_PUER_P_Field_Array is array (0 .. 31)
     of PIO_PIO_PUER_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_PUSR_P array element
   subtype PIO_PIO_PUSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_PUSR_P array
   type PIO_PIO_PUSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_PUSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_ABCDSR_P array element
   subtype PIO_PIO_ABCDSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_ABCDSR_P array
   type PIO_PIO_ABCDSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_ABCDSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_IFSCDR_P array element
   subtype PIO_PIO_IFSCDR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_IFSCDR_P array
   type PIO_PIO_IFSCDR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_IFSCDR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_IFSCER_P array element
   subtype PIO_PIO_IFSCER_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_IFSCER_P array
   type PIO_PIO_IFSCER_P_Field_Array is array (0 .. 31)
     of PIO_PIO_IFSCER_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_IFSCSR_P array element
   subtype PIO_PIO_IFSCSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_IFSCSR_P array
   type PIO_PIO_IFSCSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_IFSCSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   subtype PIO_PIO_SCDR_DIV_Field is Interfaces.SAM.UInt14;
   ...
   --  PIO_PIO_PPDDR_P array element
   subtype PIO_PIO_PPDDR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_PPDDR_P array
   type PIO_PIO_PPDDR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_PPDDR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_PPDER_P array element
   subtype PIO_PIO_PPDER_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_PPDER_P array
   type PIO_PIO_PPDER_P_Field_Array is array (0 .. 31)
     of PIO_PIO_PPDER_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_PPDSR_P array element
   subtype PIO_PIO_PPDSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_PPDSR_P array
   type PIO_PIO_PPDSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_PPDSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_OWER_P array element
   subtype PIO_PIO_OWER_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_OWER_P array
   type PIO_PIO_OWER_P_Field_Array is array (0 .. 31)
     of PIO_PIO_OWER_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_OWDR_P array element
   subtype PIO_PIO_OWDR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_OWDR_P array
   type PIO_PIO_OWDR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_OWDR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_OWSR_P array element
   subtype PIO_PIO_OWSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_OWSR_P array
   type PIO_PIO_OWSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_OWSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_AIMER_P array element
   subtype PIO_PIO_AIMER_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_AIMER_P array
   type PIO_PIO_AIMER_P_Field_Array is array (0 .. 31)
     of PIO_PIO_AIMER_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_AIMDR_P array element
   subtype PIO_PIO_AIMDR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_AIMDR_P array
   type PIO_PIO_AIMDR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_AIMDR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_AIMMR_P array element
   subtype PIO_PIO_AIMMR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_AIMMR_P array
   type PIO_PIO_AIMMR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_AIMMR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_ESR_P array element
   subtype PIO_PIO_ESR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_ESR_P array
   type PIO_PIO_ESR_P_Field_Array is array (0 .. 31) of PIO_PIO_ESR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_LSR_P array element
   subtype PIO_PIO_LSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_LSR_P array
   type PIO_PIO_LSR_P_Field_Array is array (0 .. 31) of PIO_PIO_LSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_ELSR_P array element
   subtype PIO_PIO_ELSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_ELSR_P array
   type PIO_PIO_ELSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_ELSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_FELLSR_P array element
   subtype PIO_PIO_FELLSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_FELLSR_P array
   type PIO_PIO_FELLSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_FELLSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_REHLSR_P array element
   subtype PIO_PIO_REHLSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_REHLSR_P array
   type PIO_PIO_REHLSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_REHLSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_FRLHSR_P array element
   subtype PIO_PIO_FRLHSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_FRLHSR_P array
   type PIO_PIO_FRLHSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_FRLHSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   --  PIO_PIO_LOCKSR_P array element
   subtype PIO_PIO_LOCKSR_P_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_LOCKSR_P array
   type PIO_PIO_LOCKSR_P_Field_Array is array (0 .. 31)
     of PIO_PIO_LOCKSR_P_Element
     with Component_Size => 1, Size => 32;
   ...
   subtype PIO_PIO_WPMR_WPEN_Field is Interfaces.SAM.Bit;
   ...
   type PIO_PIO_WPMR_Register is record
      ...
      WPEN         : PIO_PIO_WPMR_WPEN_Field := 16#0#;
      --  unspecified
   ...
   subtype PIO_PIO_WPSR_WPVS_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_WPSR_WPVSRC_Field is Interfaces.SAM.UInt16;

   --  Write Protection Status Register
   type PIO_PIO_WPSR_Register is record
      --  Read-only. Write Protection Violation Status
      WPVS           : PIO_PIO_WPSR_WPVS_Field;
      --  unspecified
   ...
   subtype PIO_PIO_VERSION_VERSION_Field is Interfaces.SAM.UInt12;
   subtype PIO_PIO_VERSION_MFN_Field is Interfaces.SAM.UInt3;
   ...
   --  PIO_PIO_SCHMITT_SCHMITT array element
   subtype PIO_PIO_SCHMITT_SCHMITT_Element is Interfaces.SAM.Bit;

   --  PIO_PIO_SCHMITT_SCHMITT array
   type PIO_PIO_SCHMITT_SCHMITT_Field_Array is array (0 .. 31)
     of PIO_PIO_SCHMITT_SCHMITT_Element
     with Component_Size => 1, Size => 32;
   ...
   subtype PIO_PIO_PCMR_PCEN_Field is Interfaces.SAM.Bit;
   ...
   subtype PIO_PIO_PCMR_ALWYS_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCMR_HALFS_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCMR_FRSTS_Field is Interfaces.SAM.Bit;

   --  Parallel Capture Mode Register
   type PIO_PIO_PCMR_Register is record
      --  Parallel Capture Mode Enable
      PCEN           : PIO_PIO_PCMR_PCEN_Field := 16#0#;
      --  unspecified
      Reserved_1_3   : Interfaces.SAM.UInt3 := 16#0#;
      --  Parallel Capture Mode Data Size
      DSIZE          : PIO_PCMR_DSIZE_Field := Interfaces.SAM.PIO.Byte;
      --  unspecified
      Reserved_6_8   : Interfaces.SAM.UInt3 := 16#0#;
      --  Parallel Capture Mode Always Sampling
      ALWYS          : PIO_PIO_PCMR_ALWYS_Field := 16#0#;
      --  Parallel Capture Mode Half Sampling
      HALFS          : PIO_PIO_PCMR_HALFS_Field := 16#0#;
      --  Parallel Capture Mode First Sample
      FRSTS          : PIO_PIO_PCMR_FRSTS_Field := 16#0#;
      --  unspecified
   ...
   subtype PIO_PIO_PCIER_DRDY_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCIER_OVRE_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCIER_ENDRX_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCIER_RXBUFF_Field is Interfaces.SAM.Bit;
   ...
   subtype PIO_PIO_PCIDR_DRDY_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCIDR_OVRE_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCIDR_ENDRX_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCIDR_RXBUFF_Field is Interfaces.SAM.Bit;
   ...
   subtype PIO_PIO_PCIMR_DRDY_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCIMR_OVRE_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCIMR_ENDRX_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCIMR_RXBUFF_Field is Interfaces.SAM.Bit;
   ...
   subtype PIO_PIO_PCISR_DRDY_Field is Interfaces.SAM.Bit;
   subtype PIO_PIO_PCISR_OVRE_Field is Interfaces.SAM.Bit;
   ...
   type PIO_PIO_PCISR_Register is record
      ...
      DRDY          : PIO_PIO_PCISR_DRDY_Field;
      --  Read-only. Parallel Capture Mode Overrun Error
      OVRE          : PIO_PIO_PCISR_OVRE_Field;
      --  unspecified
   ...
   type PIO_Peripheral is record
      ...
      PIO_PCRHR   : aliased Interfaces.SAM.UInt32;
   end record
     with Volatile;
