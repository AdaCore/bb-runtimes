...
package Interfaces.STM32.RCC is
   ...
   type AHB1RSTR_Register is record
      ...
      --  unspecified
      Reserved_23_24 : Interfaces.STM32.UInt2 := 16#0#;
      --  Ethernet MAC reset
   ...
   type AHB2RSTR_Register is record
      ...
      --  unspecified
      Reserved_1_5  : Interfaces.STM32.UInt5 := 16#0#;
   ...
   subtype AHB3RSTR_FSMCRST_Field is Interfaces.STM32.Bit;
   ...
   subtype AHB3ENR_FSMCEN_Field is Interfaces.STM32.Bit;
   ...
   type AHB2LPENR_Register is record
      ...
      --  unspecified
      Reserved_1_5  : Interfaces.STM32.UInt5 := 16#18#;
   ...
   subtype AHB3LPENR_FSMCLPEN_Field is Interfaces.STM32.Bit;
