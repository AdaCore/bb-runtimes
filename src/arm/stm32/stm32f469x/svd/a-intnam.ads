...
--  This is a version for the STM32F46_79x MCU
package Ada.Interrupts.Names is
   ...
   CRYP_Interrupt                : constant Interrupt_ID := 79;
   ...
   QUADSPI_Interrupt             : constant Interrupt_ID := 91;

   --  DSI event interrupt
   DSI_Interrupt                 : constant Interrupt_ID := 92;
