...
package body System.Machine_Reset is
   ...
   procedure Os_Exit (Status : Integer) is
      ...
      procedure Reset_System (Mode : Integer);
      pragma Import (C, Reset_System, "XM_halt_system");
      --  Halt the system.  Might be too strong and could be replaced by
      --  call to reset_partition or halt_partition.
