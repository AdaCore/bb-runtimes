...
--  This is the implementation for Cortex-A/R profile targets in C64 mode
--  as implemented by the Morello platform.
...
function Generic_SH_Call
  (Op    : Syscall;
   ...
   Ret : SH_Word;
begin
   Asm ("mov w0, %w1" & ASCII.LF & ASCII.HT &
        "mov c1, %2" & ASCII.LF & ASCII.HT &
        "hlt #0xF000" & ASCII.LF & ASCII.HT &
        "mov %0, x0",
