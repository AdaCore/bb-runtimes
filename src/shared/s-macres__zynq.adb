...
package body System.Machine_Reset is
   ...
   procedure Os_Exit (Status : Integer) is
      ...
      SLCR_UNLOCK : Interfaces.Unsigned_32
        with Address => System'To_Address (16#F800_0008#), Volatile, Import;

      SLCR_PSS_RST_CTRL : Interfaces.Unsigned_32
        with Address => System'To_Address (16#F800_0200#), Volatile, Import;
   begin
      SLCR_UNLOCK := 16#Df0d#;
