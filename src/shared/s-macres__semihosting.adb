...
--  This is the semihosting version of System.Machine_Reset

with System.Semihosting; use System.Semihosting;
...
package body System.Machine_Reset is
   ...
   SIGABRT : constant Exit_Subcode := 6;
   ...
   begin
      loop
         SH_Exit (ADP_Stopped_RunTimeErrorUnknown, SIGABRT);
      end loop;
   end Os_Abort;
   ...
   begin
      loop
         SH_Exit (ADP_Stopped_ApplicationExit, Exit_Subcode (Status));
      end loop;
   end Os_Exit;
