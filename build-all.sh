...
build_zfp_stm32f769()
{
    do_zfp arm-eabi zfp/stm32f769disco
}

build_sfp_stm32f769()
{
    do_ravenscar arm-eabi ravenscar-sfp/stm32f769disco
}
...
{
    do_zfp arm-sysgo-pikeos4 zfp/arm-pikeos4.2
}

build_sfp_arm_pikeos4.2()
{
    do_ravenscar arm-sysgo-pikeos4 ravenscar-sfp/arm-pikeos4.2
}

build_full_arm_pikeos4.2()
{
    do_ravenscar arm-sysgo-pikeos4 ravenscar-full/arm-pikeos4.2
}
	  ...
	  # ARM based
          ...
          stm32f769)
              case $opt in
                  ...
                  sfp)  build_sfp_stm32f769 ;;
                  full) build_full_stm32f769 ;;
                  *) echo "Unknown command $opt for target $target"; exit 2;;
              esac
              ;;
          sam4s)
