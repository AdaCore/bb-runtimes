...
package Interfaces.FE310.UART is
   pragma Preelaborate;
   ...
   subtype TXDATA_DATA_Field is Interfaces.FE310.Byte;
   ...
   subtype RXDATA_DATA_Field is Interfaces.FE310.Byte;
   ...
   subtype TXCTRL_TXCNT_Field is Interfaces.FE310.UInt3;
   ...
   type TXCTRL_Register is record
      ...
      NSTOP          : Boolean := False;
      --  unspecified
      Reserved_2_15  : Interfaces.FE310.UInt14 := 16#0#;
   ...
   subtype RXCTRL_RXCNT_Field is Interfaces.FE310.UInt3;

   --  Receive Control Register.
   type RXCTRL_Register is record
      ENABLE         : Boolean := False;
      --  unspecified
      Reserved_1_15  : Interfaces.FE310.UInt15 := 16#0#;
   ...
   subtype DIV_DIV_Field is Interfaces.FE310.UInt16;
