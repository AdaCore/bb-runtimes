...
class SourceDirs(SharedFilesHolder):
    ...
    def init_full(self):
        ...
        self.add_sources('full', [
            ...
            'a-sbecin.ads', 'a-sbecin.adb',
            'a-sbhcin.ads', 'a-sbhcin.adb',
            'a-sblcin.ads', 'a-sblcin.adb',
            'a-secain.ads', 'a-secain.adb',
            'a-sfecin.ads',
            'a-sfhcin.ads',
            'a-sflcin.ads',
            'a-shcain.ads', 'a-shcain.adb',
            'a-slcain.ads', 'a-slcain.adb',
            'a-stboha.ads', 'a-stboha.adb',
            'a-stfiha.ads',
            'a-strhas.adb', 'a-strhas.ads',
            'a-stmaco.ads',
            ...
            'a-stunha.ads', 'a-stunha.adb',
            'a-stuten.ads', 'a-stuten.adb',
            'a-stwibo.ads', 'a-stwibo.adb',
            'a-stwifi.ads', 'a-stwifi.adb',
            'a-stwiha.ads', 'a-stwiha.adb',
            'a-stwima.ads', 'a-stwima.adb',
            'a-stwise.ads', 'a-stwise.adb',
            'a-stwisu.ads', 'a-stwisu.adb',
            'a-stwiun.ads', 'a-stwiun.adb',
            'a-stzbou.ads', 'a-stzbou.adb',
            'a-stzfix.ads', 'a-stzfix.adb',
            'a-stzhas.ads', 'a-stzhas.adb',
            'a-stzmap.ads', 'a-stzmap.adb',
            'a-stzsea.ads', 'a-stzsea.adb',
            'a-stzsup.ads', 'a-stzsup.adb',
            'a-stzunb.ads', 'a-stzunb.adb',
            'a-suecin.ads', 'a-suecin.adb',
            'a-suenco.ads', 'a-suenco.adb',
            'a-suenst.ads', 'a-suenst.adb',
            'a-suewst.ads', 'a-suewst.adb',
            'a-suezst.ads', 'a-suezst.adb',
            'a-suhcin.ads', 'a-suhcin.adb',
            'a-sulcin.ads', 'a-sulcin.adb',
            'a-swbwha.ads', 'a-swbwha.adb',
            'a-swfwha.ads',
            'a-swunau.ads', 'a-swunau.adb',
            'a-swuwha.ads', 'a-swuwha.adb',
            'a-swmwco.ads',
            'a-szbzha.ads', 'a-szbzha.adb',
            'a-szfzha.ads',
            'a-szmzco.ads',
            'a-szunau.ads', 'a-szunau.adb',
            'a-szuzha.ads', 'a-szuzha.adb',
            'a-tags.ads',   'a-tags.adb',
            'a-undesu.ads', 'a-undesu.adb',
            'a-widcha.ads',
            'a-wichha.ads', 'a-wichha.adb',
            'a-wichun.ads', 'a-wichun.adb',
            'a-zchara.ads',
            'a-zchhan.ads', 'a-zchhan.adb',
            'a-zchuni.ads', 'a-zchuni.adb',
            ...
            's-init.ads', 'hie/s-init/bb/s-init.adb',
            's-io.ads', 'hie/s-io.adb',
