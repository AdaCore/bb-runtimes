...
class PikeOS(Target):
    ...
    def __init__(self):
        ...
        self.add_gnat_sources(
            "shared/s-textio__pikeos.adb", "shared/s-macres__libc.adb"
        )
        self.add_gnarl_source("shared/a-intnam__dummy.ads")

    def dump_runtime_xml(self, rts_name, rts):
        cnt = resolve_and_read_file(Path("pikeos/runtime.xml"))
    ...
    def amend_rts(self, rts_profile, conf):
        ...
        # Add PikeOS-specific scenarios
        conf.rts_vars["Pikeos_Version"] = self.pikeos_version
        ...
        if self.pikeos_version == "pikeos3":
            ...
            conf.build_flags["common_flags"] = filter(
                lambda x: x not in ["-ffunction-sections", "-fdata-sections"],
...
class ArmPikeOS42(PikeOS):
    ...
    def dump_runtime_xml(self, rts_name, rts):
        return resolve_and_read_file(Path("pikeos/runtime_p4ext.xml"))
...
TARGETS = [ArmPikeOS(), ArmPikeOS42(), AArch64PikeOS5(), ArmPikeOS5(), PPCPikeOS5()]
