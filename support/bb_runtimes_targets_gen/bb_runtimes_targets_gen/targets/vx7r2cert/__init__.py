...
class Vx7r2Cert(Target):
    """VxWorks 7 r2 Certified target base class."""

    _is_rtp: bool
    """Whether this target is an RTP variant."""

    _rtp_suffix: str
    """Suffix to append to the runtime name, only has value '-rtp' if _is_rtp is True."""
    ...
    def runtime_name_generator(self, base_profile: ProfileNameType) -> str:
        return "rts-" + base_profile + self._rtp_suffix
    ...
    def __init__(self, is_rtp):
        ...
        self.add_gnat_sources("shared/s-macres__vx7r2cert.adb")
...
TARGETS = [
    AArch64Vx7r2Cert(is_rtp=False),
    AArch64Vx7r2Cert_RTP(),
    MorelloVx7r2Cert(is_rtp=False),
    MorelloVx7r2Cert_RTP(),
    ArmVx7r2Cert(is_rtp=False),
    ArmVx7r2Cert_RTP(),
    PPCVx7r2Cert(is_rtp=False),
    PPCVx7r2Cert_RTP(),
    PPC64Vx7r2Cert(is_rtp=False),
    PPC64Vx7r2Cert_RTP(),
    X86Vx7r2Cert(is_rtp=False),
    X86Vx7r2Cert_RTP(),
    X86_64Vx7r2Cert(is_rtp=False),
    X86_64Vx7r2Cert_RTP(),
]
